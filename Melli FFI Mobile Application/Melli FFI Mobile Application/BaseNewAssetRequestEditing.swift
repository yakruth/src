//
//  BaseNewAssetRequestEditing.swift
...
/*!
Represents the base new asset request editing view controller class.

*/
class BaseNewAssetRequestEditing: KeyboardViewController /*VoiceRecogniserDelegate */ {
    ...
    var summaryNotesConfigurer: GeneralCellConfigurer<NSString, AssetSummaryUrgencyNotesTableViewCell>!
    ...
    override func viewDidLoad() {
        ...
        tableView.registerNib(UINib(nibName: "AssetSummaryUrgencyNotesTableViewCell", bundle: nil),
            forCellReuseIdentifier: "summary")
        
        summaryText = "General Break/Fix"    //request.summary
        notesText = request.notes
        urgency = request.urgency
        template = TemplateLeaf(name: "General Break/Fix", templateId: "HTP000000006379",
            instanceId: "AGHAA5V0H38QXAN4I5BE369MO6LO20",
            usedbyACS: "", usedByAERO: "", usedByCORP: "", usedByPMT: "", usedByTS: "",
            internalIT: "", keywords: "", templateName: "GEN BREAK/FIX")          //request.template
        requestedName = AuthenticationUtil.getUserInfo()?.getFullName() ?? ""
        requestedForEid = AuthenticationUtil.getUserInfo()?.username ?? ""
        
        summaryNotesConfigurer = GeneralCellConfigurer<NSString, AssetSummaryUrgencyNotesTableViewCell> { [weak self] (cell, _, _) -> Void in
            ...
            cell.assetNameTextField.text = self!.assetsEntity.ciName
            cell.assetNameTextField.delegate = self
    ...
    @IBAction func pickerDoneTapped(sender: AnyObject) {
        ...
        if let cell = tableView.cellForRowAtIndexPath(NSIndexPath(forRow: 0, inSection: 0)) as? AssetSummaryUrgencyNotesTableViewCell {
            cell.urgencyDropDown.textField.text = urgency.rawValue.localized ?? "selectUrgency".localized
        } else if let cell = tableView.cellForRowAtIndexPath(NSIndexPath(forRow: 1, inSection: 0)) as? AssetSummaryUrgencyNotesTableViewCell {
            cell.urgencyDropDown.textField.text = urgency.rawValue.localized ?? "selectUrgency".localized
        }
...
extension BaseNewAssetRequestEditing : UIAlertViewDelegate {
    /**
...
extension BaseNewAssetRequestEditing: UITextFieldDelegate {
    /**
...
extension BaseNewAssetRequestEditing : UITextViewDelegate {
...
extension BaseNewAssetRequestEditing : UIPickerViewDataSource, UIPickerViewDelegate {
...
extension BaseNewAssetRequestEditing : AttachmentViewDelegate    {
...
extension BaseNewAssetRequestEditing : UIImagePickerControllerDelegate, UINavigationControllerDelegate    {
...
extension BaseNewAssetRequestEditing : EmployeeSearchViewControllerDelegate  {
    /**
